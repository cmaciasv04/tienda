...
<nav class="navbar navbar-expand-lg nav-bar navbar-light bg-light">
    <div class="container">
        	 <div class="heading animate-box"><h4><b><span class="text-org">Bienvenido Doctor-</span> <span class="text-gr">
			...
			<li class="nav-item"><a class="nav-link nav-btn active" href="datospersonalesdoctor.php">Mis datos</a></li>
            <li class="nav-item"><a class="nav-link nav-btn active" href="datoscitadoc.php">Mis citas</a></li>
		...
		<table class="table table-striped table-hover">
			...
			<tbody>
				<?php
				     ...
				     $result=mysqli_query($conexion,"SELECT * FROM datosdoctor where iddoctor='$user'");				    
					 ...
					 echo "<td id='fecha:$user' class='cam_editable' contenteditable='true'>".$usuarios['especialidad']."</td>";
