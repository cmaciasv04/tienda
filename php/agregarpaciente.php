...
//	echo $busquedausuario;	
	if(empty($busquedacedula)&&empty($busquedausuario)){		
		...
		$insertar="INSERT INTO datosusuario (idusuario, cedula, nombre, apellido, direccion, correo, telefono, fecha, sexo, cita) VALUES ('$nombreusuario', '$cedula', '$nombre', '$apellido','$direccion', '$correo', '$telefono','$fecha', '$sexo', 0)";
