...
<div class="container" id="fh5co-contact">
        <div class="heading animate-box"><h2><b>Estas son tu citas</b></h2></div>
		...
		<table class="table table-striped table-hover">
			...
			<tbody>
				<?php
				     ...
				     $result=mysqli_query($conexion,"SELECT * FROM datoscita where idcita='$user'");			    
					 ...
					 echo "<td id='nom_doc:$user' class='cam_editable' contenteditable='true'>".$usuarios['nom_doc']."</td>";
					 echo "<td id='fecha:$user' class='cam_editable' contenteditable='true'>".$usuarios['fecha']."</td>";
					 echo "<td id='especialidad:$user' class='cam_editable' contenteditable='true'>".$usuarios['especialidad']."</td>";
					 echo "<td id='comentario:$user' class='cam_editable' contenteditable='true'>".$usuarios['comentario']."</td>";
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title">Cambion de  contraseña</h4>
            </div>
